...
switch ($accion) {
	case 'btnAgregar':
		...
		$sentencia="INSERT INTO editoriales(CodEditorial,Direccion,Nombre,Imagen) VALUES ('$txtCodEditorial','$txtDireccion','$txtNombre','$nombreArchivo') ";
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        <div class="form-row">
								...
								<input type="file" class="form-control" accept="image/*"  name="txtImagen" value="<?php echo $txtImagen;?>" placeholder="" id="txtImagen" >
								<br>
								<label for="">Audio:</label>
								<input type="file" class="form-control" accept="audio/*"  name="txtAudio" value="<?php echo $txtAudio;?>" placeholder="" id="txtAudio" >
								<br>
				        </div>
				      </div>
